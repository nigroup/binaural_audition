...
name = 'glmnet_-sf_+wns_500ms_nsaEQnss' # needs to correspond to the mat filename

remark = ' -- attention: simple blocks were ignored in the model evaluation (more difficult problem)!'
