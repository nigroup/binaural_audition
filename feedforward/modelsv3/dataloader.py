...
class DataLoader:
    ...
    def __init__(self, mode, label_mode, fold_nbs, scene_nbs, batchsize=50, timesteps=4000, epochs=10,
                 buffer=10, features=160, classes=13, path_pattern=settings.dir,
        ...
        self.buffer_add_memory = 0
        self.buffer_add_timesteps = 0
        self.buffer_add_iterations = 0
        self.add_max_positions = 0
        self.check_slices_y = 0
        self.check_slices_xy = 0
    ...
    def _parse_sequence(self, row_ind, act_file_ind, start_in_sequence):
        with np.load(self.filenames[act_file_ind]) as data:
            ...
            self.buffer_add_timesteps += end-start
    ...
    def _calculate_length(self):
        ...
        length_dict = self._length_dict() #dict with file: length
