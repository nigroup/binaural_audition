...
import time
import datetime
from dataloader_instant import *
...
class HyperParameters:
    ...
    def validation(self, batch_size):
        with tf.name_scope('LDNN'):
            ...
            return valid_iterator, sensitivity, specificity, f1, reset_op,handle,TP1,TN1,FP1,FN1,loss_op,update_op
    ...
    def main(self):
        with tf.variable_scope('LDNN') as scope:
            ...
            # -----------------------validation graph---------
            valid_iterator, valid_sensitivy, valid_specifict, valid_f1, reset_op, handle_valid,TP,TN,FP,FN,loss_validation,update_op1 = self.validation(self.VALIDATION_BATCH_SIZE)
