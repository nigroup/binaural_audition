...
from hypersearch.modelrnn import hyperparameters as HyperParameters
import numpy as np
import signal
import sys
import pickle
...
space = {
    ...
    'NUM_HIDDEN': hp.qloguniform('NUM_HIDDEN', 1, 3, 1),
    #Returns a value like round(exp(uniform(low, high)) / q) * q
    'NUM_MLP': hp.quniform('NUM_MLP', 0, 3, 1),
    'NUM_NEURON': hp.qloguniform('NUM_NEURON', 1, 3, 1),
